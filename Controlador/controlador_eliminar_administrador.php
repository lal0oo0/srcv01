...
/*cambiar alertas*/
    ...
    <strong>Exito!</strong> El usuario se ha desactivado correctamente.
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
  </div>';
    } else {
    // Error: alerta de Bootstrap error con detalles
    $mensaje = '<div class="alert alert-danger" role="alert">Error al desactivar al usuario.' . mysqli_error($conexion) . '</div>';
    }
