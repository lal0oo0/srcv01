...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["correo"])) {
    ...
    if (filter_var($correo, FILTER_VALIDATE_EMAIL)) {
        ...
        if ($result->num_rows > 0) {
            ...
            // Guardar el correo electrónico en la sesión para usarlo en la siguiente interfaz
            $_SESSION['correo'] = $correo;
            ...
            if ($mail->send()) {
                // Redireccionar a la siguiente interfaz donde se solicitará el código de verificación
