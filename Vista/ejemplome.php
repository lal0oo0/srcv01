          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="../Controlador/controlador_registro_reservacion.php" class="formulario row g-3 needs-validation" method="POST" novalidate>
                ...
                <input type="text" class="form-control" name="Nombre" id="Nombre" placeholder="Nombre" aria-label="nombre" aria-describedby="basic-addon1" pattern="^(?=.*[a-z])(?=.*[A-Z])[A-Za-z ]{3,30}$"required>
                ...
                <div class="row">
                  <div class="col">
                    ...
                    <input type="text" class="form-control" name="Apellidopaterno" id="apellidopaterno" placeholder="Apellido paterno" aria-label="Apellido paterno" aria-describedby="basic-addon1" pattern="^(?=.*[a-z])(?=.*[A-Z])[A-Za-z]{3,30}$" required>
                    <div class="invalid-feedback">
                      Verifique los datos
                    </div>
                  </div>
                  <div class="col">
                    ...
                    <input type="text" class="form-control" name="Apellidomaterno" id="apellidomaterno" placeholder="Apellido materno" aria-label="Apellido materno" aria-describedby="basic-addon1" pattern="^(?=.*[a-z])(?=.*[A-Z])[A-Za-z]{3,30}$" required>
                    <div class="invalid-feedback">
                      Verifique los datos
                    </div>
                  </div>
