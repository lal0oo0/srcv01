    ...
    <div class="offcanvas offcanvas-end navbar-custom" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
          ...
          <li class="nav-item">
            <a class="nav-link" aria-current="page" href="vista_envio_spam.php">Spam</a>
          </li>
          <li class="nav-item">
      ...
      <div class="table-responsive my-custom-scrollbar">
        <table class="table table-bordered table-striped mb-0">
          ...
          <?php
              require_once("../Modelo/conexion2.php");
              $conexion = conect();
              $query = mysqli_query ($conexion, "SELECT * FROM srcv_visitas WHERE ESTATUS= '1' AND EMPRESA LIKE '%Ur%' ORDER BY FECHA DESC, ENTRADA_SEGURIDAD DESC");
          ...
          <tr class="datos">
                    <td>
                        ...
                        <a href="../Controlador/controlador_entrada_visitas_urspace.php?id=<?=$filas['ID_VISITA']?>" id="botonEntrada" class="btn btn-info btn-sm" style="font-size: 10px; color: black; padding: 2px 5 px; height: 20px; line-height: 1;">Entrada
                    ...
                    <td>
                        ...
                        <a href="../Controlador/controlador_salida_visitas_urspace.php?id=<?=$filas['ID_VISITA']?>" id="botonSalida" class="btn btn-info btn-sm" style="font-size: 10px; color: black; padding: 2px 5 px; height: 20px; line-height: 1;">Salida
                        <i class="fa fa-sign-in" aria-hidden="true" style="font-size: 12px;"></i></a>
                        <?php
                        }else{
                  ...
                  <!-- Modificar visitas -->
                  <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal_<?php echo $filas['ID_VISITA'] ?>" onclick="VISITA('<?php $filas['ID_VISITA'] ?>')" class="btn btn-warning btn-sm" style="font-size: 10px; color: black; padding: 2px 5 px; height: 20px; line-height: 1;" id="botonMotivo">Motivo
